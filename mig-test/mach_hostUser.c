/*
 * IDENTIFICATION:
 * stub generated Wed Nov 13 21:46:48 2019
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__mach_host_subsystem__
#if !defined(__MIG_check__Reply___kernelrpc_host_create_mach_voucher_t__defined)
#define __MIG_check__Reply___kernelrpc_host_create_mach_voucher_t__defined

mig_internal kern_return_t __MIG_check__Reply___kernelrpc_host_create_mach_voucher_t(__Reply___kernelrpc_host_create_mach_voucher_t *Out0P)
{

	typedef __Reply___kernelrpc_host_create_mach_voucher_t __Reply __attribute__((unused));
	boolean_t msgh_simple;
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
...
#endif /* !defined(__MIG_check__Reply___kernelrpc_host_create_mach_voucher_t__defined) */
#endif /* __MIG_check__Reply__mach_host_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine _kernelrpc_host_create_mach_voucher */
mig_external kern_return_t _kernelrpc_host_create_mach_voucher
(
	host_t host,
...
#ifdef	__MIG_check__Reply___kernelrpc_host_create_mach_voucher_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply___kernelrpc_host_create_mach_voucher_t__defined */

	__DeclareSendRpc(222, "_kernelrpc_host_create_mach_voucher")
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(222, "_kernelrpc_host_create_mach_voucher")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(222, "_kernelrpc_host_create_mach_voucher")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply___kernelrpc_host_create_mach_voucher_t__defined)
	check_result = __MIG_check__Reply___kernelrpc_host_create_mach_voucher_t((__Reply___kernelrpc_host_create_mach_voucher_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply___kernelrpc_host_create_mach_voucher_t__defined) */
